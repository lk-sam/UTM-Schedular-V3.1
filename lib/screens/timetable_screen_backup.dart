//This file is to back up the previous developing code
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                      ...
                      child: Row(
                        children: [
                          ...
                          IconButton(
                              ...
                              onPressed: () async => {
                                    await FirebaseAPI.createOrUpdate(
                                        _nameController,
                                        _priceController,
                                        context,
                                        _productss,
                          ...
                          IconButton(
                              ...
                              onPressed: () async => {
                                    await FirebaseAPI.deleteProduct(
                                        documentSnapshot.id,
                                        _productss,
                                        context)
                                  })
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => FirebaseAPI.createOrUpdate(
            _nameController, _priceController, context, _productss),
